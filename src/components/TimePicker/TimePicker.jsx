...
const MyTimePicker = ({time, handleChangeTime}) => {
  ...
  const setTime = (value) => {
    ...
    return new Date(time.getFullYear(), time.getMonth(), time.getDate(),hour, minutes)
  }

  return (
      <TimePicker onChange={onChange} value={value} autoFocus={true} 
